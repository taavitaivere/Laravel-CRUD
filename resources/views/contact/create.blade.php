<x-app-layout>
    ...
    <div class="my-8 flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        ...
        <form class="max-w-screen-md w-full" method="POST" action="{{ route('contact.store') }}">
        @csrf
        ...
        <!-- Name -->
            ...
            <div>
                ...
                <x-input id="phone" class="block mt-1 w-full" type="tel" name="phone" :value="old('phone')" autofocus />
            </div>
            <div>
            ...
            <div>
                ...
                <x-checkbox id="employee" class="block mt-1 w-full" name="employee" :selected="old('employee')" autofocus />
            </div>
